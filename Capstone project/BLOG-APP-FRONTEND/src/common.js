...
export const logoutbtn1 = " bg-red-500 text-white rounded-lg hover:bg-red-600 transition duration-200 w-20 p-0.5"

// --- Articels design 

export const articleCard =
    "bg-white shadow-md rounded-lg p-5 border border-gray-200 hover:shadow-lg transition duration-200";

export const articleAuthor =
    "text-blue-600 font-semibold text-sm";

export const articlesTitle =
    "text-xl font-bold mt-1 text-gray-800";

export const articleContent =
    "text-gray-600 mt-2 line-clamp-3";

export const viewBtn =
    "mt-3 bg-blue-500 text-white px-4 py-1 rounded-md hover:bg-blue-600 transition duration-200";

export const articlesGrid = "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 pl-40 pb-10 pr-40 pt-10 bg-gray-300";
